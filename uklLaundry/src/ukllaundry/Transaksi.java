...
public class Transaksi  {
 ...
 if (temp!=99){
 idLaundry.add(temp);
 System.out.print(jenislaundry.getJenisLaundry(idLaundry.get(i))+ "sebanyak : ");
 ...
 total+=jumlah;
 System.out.println(jenislaundry.getJenisLaundry(idLaundry.get(j))+"\t"+banyak.get(j)+"\t"+jenislaundry.getharga(idLaundry.get(j))+"\t"+jumlah);
